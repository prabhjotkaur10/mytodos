describe('omdb http service', function(){
  ...
  //inject or mock the service/ factory component
  beforeEach(inject(function(_omdbApi1_, _$httpBackend_){
    omdbApi1 = _omdbApi1_;
